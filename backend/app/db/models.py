...
class Finding(Base):
    ...
    id:Mapped[str]=mapped_column(String, primary_key=True, default=uid); mission_id:Mapped[str]=mapped_column(ForeignKey('missions.id')); host_id:Mapped[str|None]=mapped_column(ForeignKey('hosts.id')); title:Mapped[str]=mapped_column(String(255)); severity:Mapped[str]=mapped_column(String(40)); description:Mapped[str]=mapped_column(Text); source:Mapped[str]=mapped_column(String(80)); confidence:Mapped[str]=mapped_column(String(40)); template_id:Mapped[str|None]=mapped_column(String(255)); template_name:Mapped[str|None]=mapped_column(String(255)); matcher_name:Mapped[str|None]=mapped_column(String(255)); matched_at:Mapped[str|None]=mapped_column(Text); host:Mapped[str|None]=mapped_column(String(255)); ip:Mapped[str|None]=mapped_column(String(80)); port:Mapped[int|None]=mapped_column(Integer); scheme:Mapped[str|None]=mapped_column(String(20)); tags:Mapped[list|None]=mapped_column(JSON); references:Mapped[list|None]=mapped_column(JSON); raw_json:Mapped[dict|None]=mapped_column(JSON); raw_event_path:Mapped[str|None]=mapped_column(Text); evidence_path:Mapped[str|None]=mapped_column(Text); created_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow)
...
class ManualActionCard(Base):
    ...
    id:Mapped[str]=mapped_column(String, primary_key=True, default=uid); mission_id:Mapped[str]=mapped_column(ForeignKey('missions.id')); capability_id:Mapped[str]=mapped_column(String(120)); title:Mapped[str]=mapped_column(String(255)); description:Mapped[str]=mapped_column(Text); risk_level:Mapped[int]=mapped_column(Integer); status:Mapped[str]=mapped_column(String(40), default='draft'); operator_note:Mapped[str|None]=mapped_column(Text); evidence_reference:Mapped[str|None]=mapped_column(Text); created_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow); updated_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow, onupdate=datetime.utcnow)


class Evidence(Base):
    __tablename__='evidence'
    id:Mapped[str]=mapped_column(String, primary_key=True, default=uid); mission_id:Mapped[str]=mapped_column(ForeignKey('missions.id')); label:Mapped[str]=mapped_column(String(255)); category:Mapped[str]=mapped_column(String(100), default='external'); description:Mapped[str|None]=mapped_column(Text); filename:Mapped[str]=mapped_column(String(255)); stored_path:Mapped[str]=mapped_column(Text); sha256:Mapped[str]=mapped_column(String(64)); size_bytes:Mapped[int]=mapped_column(Integer); mime_type:Mapped[str|None]=mapped_column(String(255)); source:Mapped[str]=mapped_column(String(100), default='external_upload'); preview_available:Mapped[bool]=mapped_column(Boolean, default=False); metadata_json:Mapped[dict|None]=mapped_column(JSON); created_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow)

class EvidenceLink(Base):
    __tablename__='evidence_links'
    id:Mapped[str]=mapped_column(String, primary_key=True, default=uid); mission_id:Mapped[str]=mapped_column(ForeignKey('missions.id')); evidence_id:Mapped[str]=mapped_column(ForeignKey('evidence.id')); target_type:Mapped[str]=mapped_column(String(80)); target_id:Mapped[str]=mapped_column(String(120)); created_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow)
...
class WebTarget(Base):
    ...
    id:Mapped[str]=mapped_column(String, primary_key=True, default=uid); mission_id:Mapped[str]=mapped_column(ForeignKey('missions.id')); host_id:Mapped[str]=mapped_column(ForeignKey('hosts.id')); url:Mapped[str]=mapped_column(String(500)); ip:Mapped[str]=mapped_column(String(80)); port:Mapped[int]=mapped_column(Integer); scheme:Mapped[str]=mapped_column(String(20)); source:Mapped[str]=mapped_column(String(80), default='nmap'); created_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow)


class BloodHoundCollection(Base):
    __tablename__='bloodhound_collections'
    id:Mapped[str]=mapped_column(String, primary_key=True, default=uid); mission_id:Mapped[str]=mapped_column(ForeignKey('missions.id')); status:Mapped[str]=mapped_column(String(40), default='created'); source:Mapped[str]=mapped_column(String(80), default='upload'); filename:Mapped[str|None]=mapped_column(String(255)); stored_path:Mapped[str|None]=mapped_column(Text); sha256:Mapped[str|None]=mapped_column(String(64)); size_bytes:Mapped[int|None]=mapped_column(Integer); zip_valid:Mapped[bool|None]=mapped_column(Boolean); zip_summary_json:Mapped[dict|None]=mapped_column(JSON); ingestion_enabled:Mapped[bool]=mapped_column(Boolean, default=False); ingestion_status:Mapped[str|None]=mapped_column(String(80)); ingestion_job_id:Mapped[str|None]=mapped_column(String(255)); ingestion_error:Mapped[str|None]=mapped_column(Text); created_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow); uploaded_at:Mapped[datetime|None]=mapped_column(DateTime); validated_at:Mapped[datetime|None]=mapped_column(DateTime); ingested_at:Mapped[datetime|None]=mapped_column(DateTime)

class BloodHoundStat(Base):
    __tablename__='bloodhound_stats'
    id:Mapped[str]=mapped_column(String, primary_key=True, default=uid); mission_id:Mapped[str]=mapped_column(ForeignKey('missions.id')); collection_id:Mapped[str|None]=mapped_column(ForeignKey('bloodhound_collections.id')); domain_name:Mapped[str|None]=mapped_column(String(255)); users_count:Mapped[int|None]=mapped_column(Integer); computers_count:Mapped[int|None]=mapped_column(Integer); groups_count:Mapped[int|None]=mapped_column(Integer); ous_count:Mapped[int|None]=mapped_column(Integer); gpos_count:Mapped[int|None]=mapped_column(Integer); domains_count:Mapped[int|None]=mapped_column(Integer); edges_count:Mapped[int|None]=mapped_column(Integer); raw_stats_json:Mapped[dict|None]=mapped_column(JSON); created_at:Mapped[datetime]=mapped_column(DateTime, default=datetime.utcnow)
