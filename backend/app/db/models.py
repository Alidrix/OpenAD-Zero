...
class Mission(Base):
    ...
    jobs=relationship('Job', cascade='all, delete-orphan'); hosts=relationship('Host', cascade='all, delete-orphan'); findings=relationship('Finding', cascade='all, delete-orphan'); next_actions=relationship('NextAction', cascade='all, delete-orphan'); smb_facts=relationship('SMBFact', cascade='all, delete-orphan'); smb_shares=relationship('SMBShare', cascade='all, delete-orphan')
class Job(Base):
    __tablename__='jobs'
